        ...
        <div>
            ...
            <Row>
                ...
                {statType.value.type === "month" &&
                    <>
                        <Select title={"Месяц"} options={selectedYear.value.title === moment().year() ? months.slice(0, moment().month() + 1) : months} selected={selectedMonth.value} setSelected={selectedMonth.setValue}/>
                        <Spacer x={0.5}/>
                    </>
                }
