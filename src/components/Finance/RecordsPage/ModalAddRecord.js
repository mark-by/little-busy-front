import {Button, Input, Modal, Row, Text, Textarea, useInput} from "@nextui-org/react";
...
export default function ModalAddRecord({visible, closeHandler, createHandler}) {
    ...
    const m = moment().zone(new Date().getTimezoneOffset())
    console.log(m.zoneAbbr(), m.zoneName());
